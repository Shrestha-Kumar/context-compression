...
export function Footer() {
  return (
    <footer className="h-[100px] mx-[60px] border-t border-surface-dim flex flex-col md:flex-row items-center justify-between text-[11px] uppercase tracking-[1px] text-ink-lighter pb-[20px] md:pb-0">
